...
class AlignmentBlockTune {
  ...
  constructor({ api, data, config, block }) {
    ...
    this.alignmentSettings = [
      ...
      {
        name: "justify",
        icon: `<svg fill="#000000" width="800px" height="800px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M3,7H21a1,1,0,0,0,0-2H3A1,1,0,0,0,3,7ZM21,17H3a1,1,0,0,0,0,2H21a1,1,0,0,0,0-2Zm0-4H3a1,1,0,0,0,0,2H21a1,1,0,0,0,0-2Zm0-4H3a1,1,0,0,0,0,2H21a1,1,0,0,0,0-2Z"/></svg>`,
      },
    ];
    this._CSS = {
      alignment: {
